...
using Java.Net;
using Java.Util;
using BuildConfig = Com.Google.Android.Exoplayer2.BuildConfig;
...
namespace ExoPlayer.Forms.Droid
{
		...
		PlaybackControlView.IVisibilityListener
	{
		...
		protected override void OnCreate(Bundle savedInstanceState)
		{
		    ...
		    _userAgent = Utils.GetUserAgent(this, "ExoPlayerDemo");
		...
		{
			base.OnStart();
			if (Com.Google.Android.Exoplayer2.Util.Util.SdkInt > 23)
			{
				initializePlayer();
			}
		}
		...
		{
			base.OnResume();
			if ((Com.Google.Android.Exoplayer2.Util.Util.SdkInt <= 23 || player == null))
			{
				initializePlayer();
			}
		}
		...
		private void initializePlayer()
		{
			...
			if (needNewPlayer)
			{
				...
				if (drmSchemeUuid != null)
				{
					...
					if (Com.Google.Android.Exoplayer2.Util.Util.SdkInt < 18)
					{
				...
				var extensionRendererMode = UseExtensionRenderers()
			...
			if (Com.Google.Android.Exoplayer2.Util.Util.MaybeRequestReadExternalStoragePermission(this, uris))
			{
		...
		{
			var drmCallback = new HttpMediaDrmCallback(licenseUrl, BuildHttpDataSourceFactory(null));
		 ...
		 */
		private IHttpDataSourceFactory BuildHttpDataSourceFactory(DefaultBandwidthMeter bandwidthMeter)
		{
		    return new DefaultHttpDataSourceFactory(_userAgent, bandwidthMeter);
        }

	    private IDataSourceFactory BuildDataSourceFactory(DefaultBandwidthMeter bandwidthMeter)
	    {
